...
def build_cases() -> list[dict[str, str]]:
    ...
    food_and_materials = [
        ...
        ("books_made_from_trees", "Books are made from trees", "true"),
        ("books_made_from_paper", "Books are made from paper", "true"),
    ...
    multilingual = [
        ...
        ("ru_books_trees", "Книги делают из деревьев", "true", "ru"),
        ("ru_books_paper", "Книги делают из бумаги", "true", "ru"),
